...
module.exports = (thorin, opt) => {
  ...
  class FormletNamespace {
    ...
    create(formlet) {
      ...
      pObj.then((res) => {
        logger.trace(`CREATE ${this.name} of ${formlet} ${dump(res)}`);
        return res;
      }, (e) => {
        logger.warn(`CREATE failed for ${this.name} of ${formlet}`);
        return e;
      }).catch((e) => {
        logger.warn(`CREATE failed for ${this.name} of ${formlet}`);
    ...
    read(id) {
      ...
      pObj.then((res) => {
        logger.trace(`READ ${this.name}: ${typeof id === 'object' ? id.id : id} ${dump(res)}`);
        return res;
      }, (e) => {
    ...
    update(id) {
      ...
      pObj.then((res) => {
        logger.trace(`UPDATE ${this.name} id: ${typeof id === 'object' ? id.id : id} ${dump(res)}`);
        return res;
      }, (e) => {
    ...
    delete(id) {
      ...
      pObj.then((res) => {
        logger.trace(`DELETE ${this.name} id: ${typeof id === 'object' ? id.id : id} ${dump(res)}`);
        return res;
      }, (e) => {
    ...
    findAll() {
      ...
      pObj.then((res) => {
        logger.trace(`FIND ${this.name} ${dump(res)}`);
        return res;
      }, (e) => {
    ...
    history(id) {
      ...
      pObj.then((res) => {
        logger.trace(`HISTORY ${this.name} id: ${typeof id === 'object' ? id.id : id} ${dump(res)}`);
        return res;
      }, (e) => {
